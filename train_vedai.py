...
model_cfg = '/workspace/yolo11/ultralytics/cfg/models/11/yolo11-fusion dwt-fly.yaml'
model = YOLO(model_cfg, task='detect')

# Train the model  
results = model.train(data='VEDAI_merge.yaml', 
                      epochs=200, 
                      imgsz=1024, 
                      batch=8, #m-20,s-32,l-12
                      ...
                      project='./runs/VEDAI', # (str, optional) project name
                      name='yolov11s_fusion', # (str, optional) experiment name, results saved to 'project/name' directory
